...
<head>
	...
	<script src="vcron.js" type="text/javascript"></script>
    <style type="text/css">
        .line {
            height: 25px;
            line-height: 25px;
                ...
                <fieldset style="border-radius: 3px; height: 220px;">
                    ...
                    <table style="height: 100px;">
                        <tbody>
                            ...
                            <tr>
                                <td>Cron 表达式:</td>
                                <td colspan="5"><input type="text" name="cron" style="width: 100%;" value="* * * * * ?"
                                        id="cron" /></td>
                                <td colspan="2"><input type="button" value="反解析到UI/校验CRON" id="btnFan" onclick="btnFan()" /></td>
                            </tr>
                            <tr >
...
function btnFan() {
    var txt = $("#cron").val();
    if (txt) {
		var result = cronValidate($("#cron").val().trim());
		if(result == true){
			alert("格式正确");  
		}
		else{
...
$(function () {
    ...
    cron.change(function () {
      ...
      /*  
       // 解析cron最近的执行时间
	   $.get('http://cron.qqe2.com/CalcRunTime.ashx',{ "CronExpression": $("#cron").val()},function(data){
